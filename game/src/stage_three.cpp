...
void StageThree::createGuards(){
    ...
    Guard * guard1 = new Guard(GUARDASSET, 30, HEADER_SIZE + 180, 18, 35, "right", 2, 10);
    ...
    Guard * guard2 = new Guard(GUARDASSET, 750, HEADER_SIZE + 50, 18, 35, "left", 2, 10);
    ...
    Guard * guard3 = new Guard(GUARDASSET, 500, HEADER_SIZE + 420, 18, 35, "right", 2, 10);
