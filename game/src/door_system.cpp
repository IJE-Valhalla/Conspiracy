...
DoorSystem::DoorSystem(std::pair<int,int> doorPosition, std::pair<int,int> switchPosition){
    door = new Door("assets/sprites/mesa.png", doorPosition.first, doorPosition.second, 30, 30);
    doorSwitch = new DoorSwitch("assets/sprites/PC_sprites(34X20).png", switchPosition.first,switchPosition.second, 30, 30);
}
